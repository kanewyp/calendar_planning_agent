...
# =============================================================================
# Renders an "Approve current schedule" button for the heuristic that the user
# has selected in the calendar view, plus a "Reject all" button. Returns the
# user's choice so app.py can resume the graph.
# =============================================================================
